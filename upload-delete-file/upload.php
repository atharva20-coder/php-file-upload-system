    ...
    if(in_array($fileActualExt, $allowed)){
        ...
        if($fileError === 0){
          if($fileSize < 1000000){
              ...
              $fileNameNew = uniqid('', true).".".$fileActualExt;    //adding extension to uploaded file with uniqe id
              ...
              $fileDestination = 'cache/'.$fileNameNew;
              ...
              header("Location: uploadingFiles.php?upload-success");
        ...
        echo "You cann't upload file of this extension!";
    }
}
